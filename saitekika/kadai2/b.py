...
def get_critical_point_with_newton(f:Function, start:float, terminate_threshold:float=10**-7) -> list[float]:
    x:float = start
    k = 0
...
if __name__ == '__main__':
    ...
    plot_with_critical_point(f, xlim=(-5, 5), critical_point=critical_point, save_path='b.pdf')
